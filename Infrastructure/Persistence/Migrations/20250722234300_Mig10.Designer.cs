...
namespace Persistence.Migrations
{
    ...
    [Migration("20250722234300_Mig10")]
    partial class Mig10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yu.Domain.Entities.CancelOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Yu.Domain.Entities.CancelOrderReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Yu.Domain.Entities.Service", b =>
                {
                    ...
                    b.Property<string>("TagTextColor")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("Yu.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ConfirmCodeGeneratedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Yu.Domain.Entities.CancelOrder", b =>
                {
                    b.HasOne("Yu.Domain.Entities.Order", "Order")
                        .WithMany("CancelOrders")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Yu.Domain.Entities.CancelOrderReason", "Reason")
                        .WithMany("CancelOrder")
            ...
            modelBuilder.Entity("Yu.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Yu.Domain.Entities.PickupDateSetting", "PickupDateSetting")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Yu.Domain.Entities.Service", b =>
                {
                    b.HasOne("Yu.Domain.Entities.File", "Icon")
                        .WithMany("IconServices")
